...
<div class="bg-gradient-to-br from-sky-50 to-blue-50 min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        <nav aria-label="Ruta de navegación" class="text-sm text-gray-600 mb-8">
            ...
            <span class="mx-2" aria-hidden="true">›</span>
            <span aria-current="page" class="text-gray-800">MV8: Espacios y Servicios</span>
        </nav>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="border-l-4 border-emerald-500 pl-6 py-4 bg-emerald-50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <button type="button" disabled aria-disabled="true" class="group p-6 bg-white rounded-lg border border-emerald-200 hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-200 text-left cursor-not-allowed">
                                    <div class="flex items-center mb-3">
                                        <svg aria-hidden="true" focusable="false" class="w-6 h-6 text-purple-600 mr-3 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12,3C13.75,3 16.25,3 18,5H22V7H20V19A2,2 0 0,1 18,21H6A2,2 0 0,1 4,19V7H2V5H6C7.75,3 10.25,3 12,3M12,5A2,2 0 0,0 10,7H14A2,2 0 0,0 12,5M6,9V19H18V9H6Z"/>
                                        </svg>
                                        <span class="font-semibold text-emerald-800 group-hover:text-emerald-900">Espacios Culturales</span>
                                    </div>
                                    ...
                                    <div class="mt-3 text-emerald-600 group-hover:text-emerald-700 text-sm font-medium">
                                        Ver galería<span class="sr-only"> (no disponible todavía)</span> <span aria-hidden="true">→</span>
                                    </div>
                                </button>

                                <button type="button" disabled aria-disabled="true" class="group p-6 bg-white rounded-lg border border-emerald-200 hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-200 text-left cursor-not-allowed">
                                    <div class="flex items-center mb-3">
                                        <svg aria-hidden="true" focusable="false" class="w-6 h-6 text-orange-600 mr-3 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M17,12C17,13.8 15.8,15.3 14.2,15.8L14.8,18H15.5C15.8,18 16,18.2 16,18.5V19.5C16,19.8 15.8,20 15.5,20H8.5C8.2,20 8,19.8 8,19.5V18.5C8,18.2 8.2,18 8.5,18H9.2L9.8,15.8C8.2,15.3 7,13.8 7,12C7,9.8 8.8,8 11,8H13C15.2,8 17,9.8 17,12M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z"/>
                                        </svg>
                                        <span class="font-semibold text-emerald-800 group-hover:text-emerald-900">Espacios Deportivos</span>
                                    </div>
                                    <p class="text-sm text-gray-600 group-hover:text-gray-700">
                                ...
                                <button type="button" disabled aria-disabled="true" class="group p-6 bg-white rounded-lg border border-emerald-200 hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-200 text-left cursor-not-allowed">
                                    <div class="flex items-center mb-3">
                                        <svg aria-hidden="true" focusable="false" class="w-6 h-6 text-green-600 mr-3 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <span class="font-semibold text-emerald-800 group-hover:text-emerald-900">Espacios Sociales</span>
                                    </div>
                                    <p class="text-sm text-gray-600 group-hover:text-gray-700">
