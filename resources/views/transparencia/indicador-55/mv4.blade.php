    ...
    <div class="bg-gradient-to-r from-gray-50 to-gray-100 border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav aria-label="Ruta de navegación" class="flex items-center space-x-2 text-sm">
                ...
                <span aria-current="page" class="text-gray-800 font-semibold">MV4: Postulantes e Ingresantes</span>
            </nav>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="space-y-8 mb-8">
                    <div class="flex items-center">
                        <div class="w-10 h-10 bg-cyan-700 rounded-full flex items-center justify-center mr-3">
                ...
                @else
                <!-- Reportes por Año (Contenido Histórico - solo si no hay datos de BD) -->
                <div class="space-y-8">
                    <!-- 2024 -->
                                ...
                                <a href="https://sinc.unamad.edu.pe:8000/media/pdf/POSTULANTES_E_INGRESANTES_2021-1_CFF8fqb.pdf" 
                                   ...
                                   class="flex items-center p-4 bg-orange-50 rounded-lg border border-orange-200 hover:bg-orange-100 transition-colors duration-200 group">
                                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-orange-100 group-hover:bg-orange-200 flex-shrink-0 mr-4">
                                        <svg aria-hidden="true" focusable="false" class="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                        </svg>
                                    </div>
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center mt-2 text-xs text-orange-700">
                                            <svg aria-hidden="true" focusable="false" class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                                            </svg>
                                            Documento PDF
                                ...
                                <a href="https://sinc.unamad.edu.pe:8000/media/pdf/POSTULANTES_E_INGRESANTES_2020-1_P6KVbiP.pdf" 
                                   ...
                                   class="flex items-center p-4 bg-red-50 rounded-lg border border-red-200 hover:bg-red-100 transition-colors duration-200 group">
                                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-red-100 group-hover:bg-red-200 flex-shrink-0 mr-4">
                                        <svg aria-hidden="true" focusable="false" class="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                        </svg>
                                    </div>
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center mt-2 text-xs text-red-700">
                                            <svg aria-hidden="true" focusable="false" class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                                            </svg>
                                            Documento PDF
                ...
                <div class="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl shadow-lg overflow-hidden border border-cyan-200 mt-8">
                    <div class="p-6">
                        ...
                        <ul role="list" class="text-cyan-700 space-y-2 text-sm">
                            <li><strong>Doble convocatoria:</strong> UNAMAD realiza dos procesos de admisión por año académico (2019-1, 2019-2, etc.)</li>
                            <li><strong>Datos desagregados:</strong> Los reportes incluyen estadísticas por facultades y carreras profesionales</li>
                            <li><strong>Modalidades de ingreso:</strong> Información sobre diferentes vías de acceso a la universidad</li>
                            <li><strong>Transparencia estadística:</strong> Datos oficiales para análisis de demanda y cobertura educativa</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-1">
                @include('transparencia.indicador-55.partials.navigation-dynamic', ['variables' => $variables ?? collect(), 'currentCodigo' => 'mv4'])
            </div>
        </div>
    </div>
@endsection