...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">🎬 Videos Destacados</h1>
    ...
    <p class="text-xs text-gray-500 mt-4">
        💡 En la página de inicio se muestra <strong>un solo video</strong>: el activo con el número de <strong>orden</strong> más bajo.
