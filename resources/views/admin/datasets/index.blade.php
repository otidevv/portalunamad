                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('admin.datasets.show', $dataset) }}" class="text-gray-600 hover:text-gray-900" title="Ver ficha">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @if(!empty($dataset->columnas))
                                        <a href="{{ route('admin.datasets.plantilla', $dataset) }}" class="text-indigo-600 hover:text-indigo-900" title="Descargar plantilla CSV">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @if($dataset->activo && $dataset->tieneDatos())
                                        <a href="{{ route('datasets.publico', $dataset->slug) }}" target="_blank" class="text-green-600 hover:text-green-900" title="Ver en el portal">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                                            </svg>
                                        </a>
                                    @endif
                                    <a href="{{ route('admin.datasets.edit', $dataset) }}" class="text-blue-600 hover:text-blue-900" title="Editar">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
