...
@section('title', 'Nueva categoría de comunicado')
@section('header', 'Nueva Categoría de Comunicado')
@section('content')
<div class="p-6">
    <!-- Header -->
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Nueva Categoría de Comunicado</h2>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="descripcion" 
                              ...
                              placeholder="Descripción opcional de la categoría" @error('descripcion') aria-invalid="true" aria-describedby="descripcion-error" @enderror>{{ old('descripcion') }}</textarea>
                    @error('descripcion')
