                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div id="visual-editor">
                        @php
                            ...
                            $isComplexType = in_array($mvType, ['mv11', 'mv12']);
                        @endphp
                        ...
                        @else
                        <!-- Editor para tipos complejos (MV11, MV12) -->
                        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="text-sm text-amber-800 font-medium">Estructura compleja detectada ({{ strtoupper($mvType) }})</p>
                                    <p class="text-xs text-amber-700 mt-1">Este tipo usa una estructura de datos avanzada. Usa el editor JSON para modificar los documentos.</p>
                                </div>
                            </div>
                        </div>
                        <div id="complex-editor-info" class="hidden"></div>
                        @endif
                    ...
                    <!-- Editor JSON (oculto por defecto para tipos simples) -->
                    <div id="json-editor" class="{{ $isComplexType ? '' : 'hidden' }}">
...
function initializeEditor() {
    try {
        ...
        // Para tipos complejos, el editor JSON ya está visible
    } catch (e) {
...
function toggleJsonMode() {
    ...
    if (isComplexType) {
        // Para tipos complejos, solo mostrar/ocultar el mensaje
        return;
    }
...
function updateJsonFromVisual() {
    ...
    if (isSimpleType) {
        ...
        return; // Para tipos complejos, usar el JSON directamente
    }
