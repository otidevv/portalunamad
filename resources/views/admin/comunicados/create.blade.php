...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Nuevo Comunicado</h2>
            <p class="text-gray-600 text-sm mt-1">Complete el formulario para crear un nuevo comunicado</p>
        </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div>
                        <label for="archivos" class="block text-sm font-medium text-gray-700 mb-1">
                            Seleccionar Archivos (Opcional, varios permitidos)
                        </label>
                        <input type="file"
                               name="archivos[]"
                               id="archivos"
