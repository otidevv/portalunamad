...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">🔗 Enlaces Normativos</h1>
    ...
    <p class="text-xs text-gray-500 mt-4">
        💡 El número de <strong>orden</strong> define la posición del enlace en la lista de la página de inicio (menor primero).
