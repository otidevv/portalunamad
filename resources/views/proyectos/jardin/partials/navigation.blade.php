<!-- Sidebar Navigation -->
<aside class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-lime-500">
    ...
    <nav class="space-y-1" aria-label="Secciones de Cuna Jardín">
    ...
    <div class="mt-8 p-4 bg-lime-50 rounded-lg border border-lime-200">
        <div class="flex items-center mb-2">
            <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-lime-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
            </svg>
