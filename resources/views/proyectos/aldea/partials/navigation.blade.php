<!-- Sidebar Navigation -->
<aside class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-purple-600">
    ...
    <nav class="space-y-1" aria-label="Secciones de Aldea Científica">
    ...
    <div class="mt-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
        ...
        <dl class="space-y-3">
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Intercambio</dt>
                    <dd class="text-xs text-purple-700">Académico internacional</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    ...
                    <dd class="text-xs text-purple-700">Estación de campo</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Laboratorios</dt>
                    <dd class="text-xs text-purple-700">Investigación avanzada</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Extensión</dt>
                    <dd class="text-xs text-purple-700">Servicios educativos</dd>
                </div>
            </div>
        </dl>
    </div>
