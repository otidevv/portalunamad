<!-- Sidebar Navigation -->
<aside class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-green-600">
    ...
    <nav class="space-y-1" aria-label="Secciones de Herbario">
    ...
    <div class="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
        ...
        <dl class="space-y-3">
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Apoyo Docente</dt>
                    <dd class="text-xs text-green-700">Trabajos de grado y máster</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    ...
                    <dd class="text-xs text-green-700">Proyectos científicos</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Referencia</dt>
                    <dd class="text-xs text-green-700">Patrón botánico</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Conservación</dt>
                    <dd class="text-xs text-green-700">Flora regional</dd>
                </div>
            </div>
        </dl>
    </div>
