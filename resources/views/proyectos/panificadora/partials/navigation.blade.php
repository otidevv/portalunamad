<!-- Sidebar Navigation -->
<aside class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-yellow-500">
    ...
    <nav class="space-y-1" aria-label="Secciones de Panificadora">
    ...
    <div class="mt-8 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
        <div class="flex items-center mb-2">
            <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-yellow-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.701 2.701 0 00-1.5-.454M9 6v2m3-2v2m3-2v2M9 3h.01M12 3h.01M15 3h.01M21 21v-7a2 2 0 00-2-2H5a2 2 0 00-2 2v7h18zM3 9h18v10a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path>
            </svg>
    ...
    <div class="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
        ...
        <dl class="space-y-3">
            ...
            <div class="flex items-start space-x-2">
                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-yellow-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                </svg>
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Investigación</dt>
                    <dd class="text-xs text-yellow-700">Desarrollo de productos</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Capacitación</dt>
                    <dd class="text-xs text-yellow-700">Cursos especializados</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Producción</dt>
                    <dd class="text-xs text-yellow-700">Productos de calidad</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Asesoría Técnica</dt>
                    <dd class="text-xs text-yellow-700">Consultoría especializada</dd>
                </div>
            </div>
        </dl>
    </div>
