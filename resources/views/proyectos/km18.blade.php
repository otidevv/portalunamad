...
@section('title', 'Complejo Polideportivo Km. 18 - UNAMAD')

@section('content')
    <!-- Hero Section -->
    <div class="relative h-64 sm:h-80 lg:h-96 overflow-hidden bg-gradient-to-r from-red-600 via-rose-600 to-pink-600">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden border-t-4 border-red-600">
                    <div class="p-12 text-center">
                        <div class="w-24 h-24 bg-gradient-to-r from-red-600 to-rose-600 rounded-full flex items-center justify-center mx-auto mb-6">
                        ...
                        <div class="max-w-md mx-auto mb-8">
                            <p class="text-gray-600 text-lg leading-relaxed">
                                Esta sección se encuentra actualmente en construcción. Pronto tendrás acceso a toda la información sobre el proyecto del Complejo Polideportivo Km. 18.
                            </p>
                        </div>

                        <div class="inline-flex items-center px-6 py-3 bg-red-100 text-red-800 rounded-full text-sm font-medium">
                            <svg aria-hidden="true" focusable="false" class="w-4 h-4 mr-2 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="lg:col-span-1">
                @include('proyectos.km18.partials.navigation')
            </div>
        </div>
    </div>
@endsection