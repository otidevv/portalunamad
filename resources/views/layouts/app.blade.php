    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
            ...
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center py-2">
                    <div class="flex space-x-4">
                        <a href="https://sgd.unamad.edu.pe/mesa-de-partes" target="_blank" class="hover:text-[#db0455] transition-colors">Mesa de Partes Virtual</a>
                        <a href="mailto:tramite-documentario@unamad.edu.pe" class="hover:text-[#db0455] transition-colors">Correo Institucional</a>
                        <a href="https://elibro.net/es/lc/unamad/login_usuario/" target="_blank" class="hover:text-[#db0455] transition-colors">Biblioteca Virtual</a>
                    </div>
                    <div class="flex items-center space-x-3">
                        <!-- Redes sociales pequeñas -->
                        <a href="https://www.facebook.com/unamad.oficial/" target="_blank" class="hover:text-[#db0455] transition-colors">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                            </svg>
                        </a>
                        <a href="https://twitter.com/unamad_oficial" target="_blank" class="hover:text-[#db0455] transition-colors">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                            </svg>
                        </a>
                        <a href="https://www.youtube.com/channel/UCUNGgRNunGECIxEd_-qv_oA" target="_blank" class="hover:text-[#db0455] transition-colors">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        @auth
                            <a href="{{ route('admin.dashboard') }}" class="hover:text-[#db0455] transition-colors" title="Panel Admin">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="hover:text-[#db0455] transition-colors" title="Iniciar Sesión">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <div class="flex items-center justify-between h-full px-4">
                ...
                <nav class="hidden lg:flex items-center space-x-8 h-full">
                    ...
                    <div class="relative group h-full">
                        <a href="#" class="nav-link flex items-center h-full {{ request()->is('universidad*') ? 'text-[#db0455] border-b-2 border-[#db0455]' : '' }}">
                            Universidad
                            ...
                            <div class="flex">
                                ...
                                <div class="w-80 flex-shrink-0">
                                    <div class="h-full relative rounded-l-lg overflow-hidden">
                                        ...
                                        <div
                                            class="absolute inset-0 bg-gradient-to-br from-[#db0455]/80 to-[#a00340]/90 flex flex-col items-center justify-center p-8 text-white">
                                            <div class="text-center">
                                ...
                                <div class="flex-1 p-8">
                                    ...
                                    <div class="grid grid-cols-1 gap-y-4">
                                        <a href="/universidad/presentacion" class="mega-dropdown-link {{ request()->is('universidad/presentacion') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                            <div
                                                class="flex items-center justify-center w-10 h-10 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                <svg class="w-5 h-5 text-[#db0455]" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                            ...
                                            <div>
                                                <span class="font-semibold {{ request()->is('universidad/presentacion') ? 'text-[#db0455]' : 'text-gray-800' }}">Presentación</span>
                                                <p class="text-xs text-gray-600 mt-1">Conoce nuestra misión, visión y
                                                    valores institucionales</p>
                                            </div>
                                        </a>

                                        <a href="/universidad/autoridades" class="mega-dropdown-link {{ request()->is('universidad/autoridades') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                            <div
                                                class="flex items-center justify-center w-10 h-10 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                <svg class="w-5 h-5 text-[#db0455]" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                            ...
                                            <div>
                                                <span class="font-semibold {{ request()->is('universidad/autoridades') ? 'text-[#db0455]' : 'text-gray-800' }}">Autoridades</span>
                                                <p class="text-xs text-gray-600 mt-1">Rectorado y equipo directivo de la
                                                    universidad</p>
                                            </div>
                                        </a>

                                        <a href="/universidad/historia" class="mega-dropdown-link {{ request()->is('universidad/historia') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                            <div
                                                class="flex items-center justify-center w-10 h-10 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                <svg class="w-5 h-5 text-[#db0455]" fill="none"
                                            ...
                                            <div>
                                                <span class="font-semibold {{ request()->is('universidad/historia') ? 'text-[#db0455]' : 'text-gray-800' }}">Historia</span>
                                                <p class="text-xs text-gray-600 mt-1">Trayectoria y evolución de
                                                    nuestra institución</p>
                                            </div>
                                        </a>

                                        <a href="/universidad/sedes" class="mega-dropdown-link {{ request()->is('universidad/sedes') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                            <div
                                                class="flex items-center justify-center w-10 h-10 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                <svg class="w-5 h-5 text-[#db0455]" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div>
                                                <span class="font-semibold {{ request()->is('universidad/sedes') ? 'text-[#db0455]' : 'text-gray-800' }}">Sedes</span>
                                                <p class="text-xs text-gray-600 mt-1">Ubicaciones y campus
                                                    universitarios</p>
                                            </div>
                                        </a>

                                        <a href="/universidad/politicas" class="mega-dropdown-link {{ request()->is('universidad/politicas') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                            <div
                                                class="flex items-center justify-center w-10 h-10 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                <svg class="w-5 h-5 text-[#db0455]" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div>
                                                <span class="font-semibold {{ request()->is('universidad/politicas') ? 'text-[#db0455]' : 'text-gray-800' }}">Política Institucional</span>
                    ...
                    <!-- Oficinas -->
                    <div class="relative group h-full">
                        <a href="#" class="nav-link flex items-center h-full">
                            Oficinas
                            <svg class="w-3 h-3 ml-1 transition-transform duration-200 group-hover:rotate-180"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="flex">
                                ...
                                <div class="w-80 flex-shrink-0">
                                    <div class="h-full relative rounded-l-lg overflow-hidden">
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-br from-[#db0455]/80 to-[#a00340]/90 flex flex-col items-center justify-center p-8 text-white">
                                            <div class="text-center">
                                ...
                                <div class="flex-1 p-8">
                                    ...
                                    <div class="grid grid-cols-2 gap-x-8 gap-y-4">
                                        ...
                                        <div>
                                            <h5 class="font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide text-[#db0455]">Órganos de Gobierno</h5>
                                            <div class="space-y-2">
                                                <a href="/oficinas/asamblea" class="oficinas-dropdown-link {{ request()->is('oficinas/asamblea') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                    ...
                                                    <span class="font-medium {{ request()->is('oficinas/asamblea') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Asamblea Universitaria</span>
                                                </a>
                                                <a href="/oficinas/consejo" class="oficinas-dropdown-link {{ request()->is('oficinas/consejo') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                        <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                                        </svg>
                                                    </div>
                                                    <span class="font-medium {{ request()->is('oficinas/consejo') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Consejo Universitario</span>
                                                </a>
                                                <a href="/oficinas/decanatura" class="oficinas-dropdown-link {{ request()->is('oficinas/decanatura') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                        <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                                        </svg>
                                                    </div>
                                                    <span class="font-medium {{ request()->is('oficinas/decanatura') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Decanatura</span>
                                                </a>
                                            </div>
                                            
                                            <h5 class="font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide text-[#db0455] mt-6">Vicerrectorados</h5>
                                            <div class="space-y-2">
                                                <div class="relative group-vicerrectorado">
                                                    <a href="#" class="oficinas-dropdown-link">
                                                        <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                            <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        <svg class="w-3 h-3 text-[#db0455] ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        <div class="p-4">
                                                            ...
                                                            <div class="space-y-2">
                                                                <a href="/oficinas/admision" class="sub-dropdown-link">
                                                                    <svg class="w-3 h-3 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            <h5 class="font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide text-[#db0455]">Oficinas Centrales</h5>
                                            <div class="space-y-2">
                                                <a href="/oficinas/secretaria" class="oficinas-dropdown-link {{ request()->is('oficinas/secretaria') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                        <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                                        </svg>
                                                    </div>
                                                    <span class="font-medium {{ request()->is('oficinas/secretaria') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Secretaría General</span>
                                                </a>
                                                <a href="/oficinas/calidad" class="oficinas-dropdown-link {{ request()->is('oficinas/calidad') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                        <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                                                        </svg>
                                                    </div>
                                                    <span class="font-medium {{ request()->is('oficinas/calidad') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Gestión de la Calidad</span>
                                                </a>
                                                ...
                                                <a href="/oficinas/ambiental" class="oficinas-dropdown-link {{ request()->is('oficinas/ambiental*') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                        <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                        </svg>
                                                    </div>
                                                    <span class="font-medium {{ request()->is('oficinas/ambiental*') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Gestión Ambiental</span>
                                                </a>
                                                <a href="/oficinas/administracion" class="oficinas-dropdown-link {{ request()->is('oficinas/administracion*') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                        <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                                                        </svg>
                                                    </div>
                                                    <span class="font-medium {{ request()->is('oficinas/administracion*') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Dirección de Administración</span>
                                                </a>
                                                <a href="/oficinas/oti" class="oficinas-dropdown-link {{ request()->is('oficinas/oti*') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                        <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                                        </svg>
                                                    </div>
                                                    <span class="font-medium {{ request()->is('oficinas/oti*') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Tecnologías de Información</span>
                                                </a>
                                                <a href="/oficinas/planeamiento" class="oficinas-dropdown-link {{ request()->is('oficinas/planeamiento*') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                        <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                                        </svg>
                                                    </div>
                                                    <span class="font-medium {{ request()->is('oficinas/planeamiento*') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Planeamiento y Presupuesto</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="flex h-full">
                                ...
                                <div class="flex-1 p-8">
                                    ...
                                    <div class="grid grid-cols-3 gap-x-8 gap-y-6">
                                        ...
                                        <div>
                                            <h5 class="font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide text-[#db0455]">Facultad de Ingeniería</h5>
                                            <div class="space-y-2">
                                                <a href="/facultades/agroindustrial" class="facultades-dropdown-link {{ request()->is('facultades/agroindustrial*') ? 'bg-[#db0455]/5 border-l-4 border-[#db0455]' : '' }}">
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                        <svg class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                                                        </svg>
                                                    </div>
                                                    <span class="font-medium {{ request()->is('facultades/agroindustrial*') ? 'text-[#db0455]' : 'text-gray-800' }} text-sm">Ingeniería Agroindustrial</span>
                                                </a>
                                        ...
                                        <div>
                                            <h5 class="font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide text-[#db0455]">Facultad de Educación</h5>
                                            <div class="space-y-2">
                                        ...
                                        <div>
                                            <h5 class="font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide text-[#db0455]">Facultad de Ecoturismo</h5>
                                            <div class="space-y-2">
                                ...
                                <div class="flex-1 p-8">
                                    ...
                                    <div class="grid grid-cols-1 gap-y-4">
                                        <a href="https://ceinfo.unamad.edu.pe/" target="_blank" rel="noopener noreferrer" class="programas-dropdown-link">
                                            <div class="flex items-center justify-center w-10 h-10 rounded-full bg-[#db0455]/10 flex-shrink-0">
                            ...
                            <div class="flex h-full">
                                ...
                                <div class="flex-1 p-8">
                                    ...
                                    <div class="grid grid-cols-1 gap-y-4">
                                        ...
                                        <a href="{{ route('documentos.publicos') }}" class="transparencia-dropdown-link">
                                            <div class="flex items-center justify-center w-10 h-10 rounded-full bg-[#db0455]/10 flex-shrink-0">
                                                <svg class="w-5 h-5 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div id="mobileMenu" class="hidden lg:hidden border-t bg-white shadow-lg">
            <nav class="px-6 py-6 flex flex-col space-y-2">
                <a href="/" class="mobile-link {{ request()->is('/') ? 'text-[#db0455] border-l-4 border-[#db0455] pl-3' : '' }}">
                ...
                <div class="mobile-dropdown">
                    <button onclick="toggleMobileSubmenu('universidad')" class="mobile-link w-full text-left justify-between {{ request()->is('universidad*') ? 'text-[#db0455] bg-[#db0455]/5' : '' }}">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                    ...
                    <div id="universidad" class="mobile-submenu hidden pl-8 mt-2 space-y-2">
                        <a href="/universidad/presentacion" class="mobile-sublink {{ request()->is('universidad/presentacion') ? 'text-[#db0455] bg-[#db0455]/10 border-l-4 border-[#db0455]' : '' }}">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            Presentación
                        </a>
                        <a href="/universidad/autoridades" class="mobile-sublink {{ request()->is('universidad/autoridades') ? 'text-[#db0455] bg-[#db0455]/10 border-l-4 border-[#db0455]' : '' }}">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                            </svg>
                            Autoridades
                        </a>
                        <a href="/universidad/historia" class="mobile-sublink {{ request()->is('universidad/historia') ? 'text-[#db0455] bg-[#db0455]/10 border-l-4 border-[#db0455]' : '' }}">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                            </svg>
                            Historia
                ...
                <!-- Oficinas -->
                <div class="mobile-dropdown">
                    <button onclick="toggleMobileSubmenu('oficinas')" class="mobile-link w-full text-left justify-between">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                    ...
                    <div id="oficinas" class="mobile-submenu hidden pl-8 mt-2 space-y-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="mobile-sub-dropdown">
                                    ...
                                    <div id="vicerrectorado-academico" class="mobile-sub-submenu hidden pl-6 mt-1 space-y-1">
                                        <a href="#" class="mobile-sub-sublink">Dirección de Admisión</a>
                                        <a href="#" class="mobile-sub-sublink">Biblioteca Central</a>
                                        <a href="#" class="mobile-sub-sublink">Asuntos Académicos</a>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="space-y-2">
                                ...
                                <a href="#" class="mobile-sublink">Gestión Ambiental</a>
                                <a href="#" class="mobile-sublink">Dirección de Administración</a>
                                <a href="#" class="mobile-sublink">Tecnologías de Información</a>
                                <a href="#" class="mobile-sublink">Planeamiento y Presupuesto</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Facultades -->
                <div class="mobile-dropdown">
                    <button onclick="toggleMobileSubmenu('facultades')" class="mobile-link w-full text-left justify-between">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"></path>
                ...
                <!-- Programas -->
                <div class="mobile-dropdown">
                    <button onclick="toggleMobileSubmenu('programas')" class="mobile-link w-full text-left justify-between">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                            </svg>
                ...
                <!-- Proyectos -->
                <div class="mobile-dropdown">
                    <button onclick="toggleMobileSubmenu('proyectos')" class="mobile-link w-full text-left justify-between">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                ...
                <!-- Transparencia -->
                <div class="mobile-dropdown">
                    <button onclick="toggleMobileSubmenu('transparencia')" class="mobile-link w-full text-left justify-between">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                    ...
                    <div id="transparencia" class="mobile-submenu hidden pl-8 mt-2 space-y-2">
                        ...
                        <a href="#" class="mobile-sublink">Documentos Normativos y de Gestión</a>
                    </div>
                </div>
            </nav>
        </div>
        ...
        <div class="relative z-10 container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start space-x-3">
                            <div class="w-5 h-5 mt-1">
                                <svg class="w-full h-full text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="https://admision.unamad.edu.pe/" target="_blank" class="text-sm text-gray-700 hover:text-[#db0455] transition-colors duration-300 flex items-center group">
                                <span class="w-1 h-1 bg-[#db0455] rounded-full mr-2 group-hover:w-2 transition-all duration-300"></span>
                                Admisión 2025
                            </a>
                        </li>
                        <li>
                            <a href="https://elibro.net/es/lc/unamad/login_usuario/" target="_blank" class="text-sm text-gray-700 hover:text-[#db0455] transition-colors duration-300 flex items-center group">
                                <span class="w-1 h-1 bg-[#db0455] rounded-full mr-2 group-hover:w-2 transition-all duration-300"></span>
                                Biblioteca Virtual
                            </a>
                        </li>
                        <li>
                            <a href="https://sgd.unamad.edu.pe/mesa-de-partes" target="_blank" class="text-sm text-gray-700 hover:text-[#db0455] transition-colors duration-300 flex items-center group">
                                <span class="w-1 h-1 bg-[#db0455] rounded-full mr-2 group-hover:w-2 transition-all duration-300"></span>
                                Mesa de Partes Virtual
                            </a>
                        </li>
                        <li>
                            <a href="mailto:tramite-documentario@unamad.edu.pe" class="text-sm text-gray-700 hover:text-[#db0455] transition-colors duration-300 flex items-center group">
                                <span class="w-1 h-1 bg-[#db0455] rounded-full mr-2 group-hover:w-2 transition-all duration-300"></span>
                                Correo Institucional
                            </a>
                        </li>
                        <li>
                            <a href="https://www.transparencia.gob.pe/enlaces/pte_transparencia_enlaces.aspx?id_entidad=13136#.YvEV03ZByUk" target="_blank" class="text-sm text-gray-700 hover:text-[#db0455] transition-colors duration-300 flex items-center group">
                                <span class="w-1 h-1 bg-[#db0455] rounded-full mr-2 group-hover:w-2 transition-all duration-300"></span>
            ...
            <div class="border-t border-gray-700 mt-8 pt-6">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    ...
                    <div class="flex items-center space-x-6 text-xs text-gray-600">
                        <a href="#" class="hover:text-[#db0455] transition-colors">Política de Privacidad</a>
                        <a href="#" class="hover:text-[#db0455] transition-colors">Términos de Uso</a>
                        <a href="#" class="hover:text-[#db0455] transition-colors">Contacto</a>
                    </div>
                </div>
            </div>
        </div>
