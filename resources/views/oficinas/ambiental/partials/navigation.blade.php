...
<div class="bg-white rounded-lg shadow-xl mb-8 overflow-hidden border-t-4 border-[#db0455]">
    ...
    <div class="p-6">
        <nav class="space-y-1" aria-label="Secciones de Gestión Ambiental">
            <a href="/oficinas/ambiental" class="ambiental-nav-link group {{ Request::is('oficinas/ambiental') ? 'active' : '' }}">
                <div class="flex items-center space-x-3">
            ...
            <a href="/oficinas/ambiental/actividades" class="ambiental-nav-link group {{ Request::is('oficinas/ambiental/actividades') ? 'active' : '' }}">
                <div class="flex items-center space-x-3">
                    <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-[#db0455]">
    ...
    <div class="space-y-3 text-sm text-gray-600">
        ...
        <div class="flex items-center space-x-2">
            ...
            <a href="mailto:ambiental@unamad.edu.pe" class="hover:text-[#db0455]">ambiental@unamad.edu.pe</a>
        </div>
    </div>
</div>
...
<style>
    ...
    .ambiental-nav-link:hover {
        background-color: #f9fafb;
        border-color: #e5e7eb;
        transform: translateX(0.25rem);
    }

    .ambiental-nav-link:hover svg {
        color: #db0455;
    }

    .ambiental-nav-link:hover svg:last-child {
        transform: translateX(0.25rem);
    }

    .ambiental-nav-link.active,
    .ambiental-nav-link[aria-current="page"] {
    ...
    .ambiental-nav-link.active svg,
    .ambiental-nav-link.active span,
    .ambiental-nav-link[aria-current="page"] svg,
    .ambiental-nav-link[aria-current="page"] span {
        color: #db0455;
    }
</style>
