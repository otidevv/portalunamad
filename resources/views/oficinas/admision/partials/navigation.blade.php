...
<aside class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-blue-500">
    <div class="text-center mb-6">
        ...
        <h2 class="text-lg font-bold text-gray-800">Dirección de Admisión</h2>
        <p class="text-sm text-gray-600">Vicerrectorado Académico</p>
    </div>

    <nav class="space-y-1" aria-label="Secciones de Admisión">
    ...
    <div class="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
        <div class="flex items-center mb-2">
            ...
            <h3 class="text-sm font-semibold text-blue-800">Acceso a la Universidad</h3>
        </div>
    ...
    <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
        <div class="flex items-center mb-3">
            ...
            <h3 class="text-sm font-semibold text-blue-800">Contacto</h3>
        </div>
        ...
        <div class="space-y-3">
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    ...
                    <p><a href="https://admision.unamad.edu.pe/" target="_blank" rel="noopener" class="text-xs text-blue-600 hover:text-blue-700 transition-colors">admision.unamad.edu.pe</a></p>
                </div>
            </div>
        </div>
    </div>
