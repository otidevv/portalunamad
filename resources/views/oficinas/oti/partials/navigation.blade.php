...
<div class="bg-white rounded-lg shadow-xl mb-8 overflow-hidden border-t-4 border-[#db0455]">
    ...
    <div class="p-6">
        <nav class="space-y-1" aria-label="Secciones de la Oficina de Tecnologías de la Información">
...
<style>
    ...
    .oti-nav-link.active,
    .oti-nav-link[aria-current="page"] {
    ...
    .oti-nav-link[aria-current="page"] svg,
    .oti-nav-link[aria-current="page"] span {
        color: #db0455;
    }
</style>
