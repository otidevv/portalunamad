    ...
    <div class="container mx-auto px-4">
        <nav aria-label="Miga de pan" class="text-sm">
            <ol class="flex items-center space-x-2">
                ...
                <li class="flex items-center"><svg aria-hidden="true" focusable="false" class="mr-2 w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path> </svg> <span aria-current="page" class="text-[#db0455] font-medium">Dirección de Admisión</span></li>
            </ol>
        </nav>
    </div>
</div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="text-center">
                                <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                                    <svg aria-hidden="true" focusable="false" class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
