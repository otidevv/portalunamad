<!-- Sidebar Navigation -->
<aside class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-green-500">
    <div class="text-center mb-6">
        ...
        <h2 class="text-lg font-bold text-gray-800">Asuntos Académicos</h2>
        <p class="text-sm text-gray-600">Vicerrectorado Académico</p>
    </div>

    <nav class="space-y-1" aria-label="Secciones de Asuntos Académicos">
    ...
    <div class="mt-8 p-4 bg-green-50 rounded-lg border border-green-200">
        <div class="flex items-center mb-2">
            <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-green-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
            </svg>
            <h3 class="text-sm font-semibold text-green-800">Gestión Académica</h3>
        </div>
    ...
    <div class="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
        <div class="flex items-center mb-3">
            ...
            <h3 class="text-sm font-semibold text-green-800">Contacto</h3>
        </div>

        <dl class="space-y-3">
            <!-- Correo - Comentado -->
            <!-- <div class="flex items-start space-x-2">
                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Correo</dt>
                    <dd class="text-xs text-green-700">-</dd>
                </div>
            </div> -->
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    ...
                    <dd class="text-xs text-green-700">Ciudad Universitaria - Tambopata</dd>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    <dt class="text-xs font-semibold text-gray-800">Horario de Atención</dt>
                    <dd class="text-xs text-green-700">Lunes a Viernes: 7:00 - 16:00</dd>
                </div>
            </div>
        </dl>
    </div>
