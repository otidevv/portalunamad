...
@section('title', 'Gestión Ambiental - Comité Ambiental Universitario - UNAMAD')
    ...
    <div class="relative text-white py-20" style="background-image: url('{{ asset('img/presentacion/presentacionbackground.jpg') }}'); background-size: cover; background-position: center; background-attachment: fixed;">
        ...
        <div class="relative z-10 container mx-auto px-4">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">Gestión Ambiental</h1>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-[#db0455] md:ml-2">Gestión Ambiental</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-lg shadow-lg p-8 border-t-4 border-[#db0455]">
                    <div class="flex items-start space-x-4 mb-8">
                        ...
                        <div>
                            <h2 class="text-3xl font-bold text-gray-800 mb-4">Comité Ambiental Universitario</h2>
                            <div class="w-20 h-1 bg-gradient-to-r from-[#b8003f] to-[#db0455]"></div>
                        </div>
                    </div>

                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        <!-- Logo del Comité Ambiental -->
                        <div class="text-center mb-8">
                            <img src="{{ asset('img/ambiental/ambiental.jpg') }}" 
                                 alt="Logotipo del Comité Ambiental Universitario de la UNAMAD" 
                                 class="mx-auto max-w-md w-full h-auto rounded-lg shadow-lg border border-gray-200">
                        </div>

                        <p class="text-lg mb-6">
                            El <strong>Comité Ambiental Universitario</strong> de la Universidad Nacional Amazónica de Madre de Dios es el órgano responsable de promover la gestión ambiental institucional y el desarrollo sostenible en nuestra universidad.
                        </p>
                        ...
                        <div class="bg-gradient-to-r from-[#db0455]/5 to-[#db0455]/5 rounded-lg p-6 mb-8 border-l-4 border-[#db0455]">
                            ...
                            <p class="text-gray-700 leading-relaxed">
                                Incorporar la dimensión ambiental y el fomento del desarrollo sostenible en la comunidad universitaria, a través de la Política Ambiental Universitaria, Plan Ambiental Universitario, programas y acciones integrales, aplicados en el ámbito formativo, de investigación, de responsabilidad social y extensión universitaria, y en la gestión institucional.
                            </p>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-6 border border-gray-200 mb-8">
                            ...
                            <ul class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <li class="flex items-start space-x-3">
                                    <div class="bg-gradient-to-r from-[#b8003f] to-[#db0455] p-2 rounded-full">
                                    ...
                                    <div>
                                        <h4 class="font-semibold text-gray-800">Formativo</h4>
                                        <p class="text-gray-600 text-sm">Educación ambiental universitaria</p>
                                    </div>
                                </li>
                                <li class="flex items-start space-x-3">
                                    <div class="bg-gradient-to-r from-[#b8003f] to-[#db0455] p-2 rounded-full">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 text-sm">Investigación ambiental aplicada</p>
                                    </div>
                                </li>
                                <li class="flex items-start space-x-3">
                                    <div class="bg-gradient-to-r from-[#b8003f] to-[#db0455] p-2 rounded-full">
                                    ...
                                    <div>
                                        <h4 class="font-semibold text-gray-800">Responsabilidad Social</h4>
                                        <p class="text-gray-600 text-sm">Extensión universitaria</p>
                                    </div>
                                </li>
                                <li class="flex items-start space-x-3">
                                    <div class="bg-gradient-to-r from-[#b8003f] to-[#db0455] p-2 rounded-full">
                                    ...
                                    <div>
                                        <h4 class="font-semibold text-gray-800">Gestión Institucional</h4>
                                        <p class="text-gray-600 text-sm">Administración ambiental</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
