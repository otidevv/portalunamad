        ...
        <div class="flex gap-8">
            ...
            <aside class="w-80 flex-shrink-0">
                        ...
                        <nav class="space-y-1" aria-label="Secciones de Gestión de la Calidad">
                            <a href="#inicio" class="calidad-nav-link active" data-section="inicio">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <svg aria-hidden="true" focusable="false" class="w-3 h-3 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div class="bg-gradient-to-r from-[#b8003f] to-[#db0455] text-white p-4">
                        <h2 class="text-lg font-bold">Datos de contacto</h2>
                    </div>
                    <div class="p-6">
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                </svg>
                                <div>
                                    <p class="text-sm text-gray-600">Teléfono:</p>
                                    <p class="font-semibold"><a href="tel:+51975845152" class="hover:text-[#db0455]">+51 975 845 152</a></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold"><a href="mailto:dugc@unamad.edu.pe" class="hover:text-[#db0455]">dugc@unamad.edu.pe</a></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1">
                ...
                <div id="inicio" class="content-section active">
                    <!-- Welcome Banner -->
                    <div class="bg-gradient-to-r from-[#b8003f] to-[#db0455] text-white rounded-lg p-8 mb-8 shadow-lg">
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-3xl font-bold mb-2">Bienvenido a la Oficina de Gestión de la Calidad</h2>
                                <p class="text-lg">Comprometidos con la excelencia académica y la mejora continua</p>
                            </div>
                            <div class="hidden md:block">
                                <svg aria-hidden="true" focusable="false" class="w-20 h-20 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-lg shadow-lg mb-8 overflow-hidden border-t-4 border-[#db0455]">
                        <div class="bg-gradient-to-r from-[#b8003f] to-[#db0455] text-white p-6">
                            <h2 class="text-2xl font-bold flex items-center">
                                <svg aria-hidden="true" focusable="false" class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="flex flex-col items-center space-y-6">
                                    ...
                                    <div class="bg-[#db0455] text-white px-6 py-4 rounded-lg shadow-lg">
                                        <div class="text-center">
                                            ...
                                            <p class="text-sm">Gestión de la Calidad</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid md:grid-cols-3 gap-8 w-full">
                                        <div class="bg-blue-700 text-white px-4 py-3 rounded-lg shadow-lg text-center">
                                            <h5 class="font-bold text-sm uppercase">Unidad de Licenciamiento</h5>
                                        </div>
                                        
                                        <div class="bg-green-700 text-white px-4 py-3 rounded-lg shadow-lg text-center">
                                            <h5 class="font-bold text-sm uppercase">Unidad de Acreditación</h5>
                                        </div>
                                        
                                        <div class="bg-purple-700 text-white px-4 py-3 rounded-lg shadow-lg text-center">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="border-l-4 border-green-500 pl-4">
                                            <h4 class="font-semibold text-green-700">Acreditación</h4>
                                    ...
                                    <div class="space-y-3">
                                        <div class="block p-3 bg-gray-50 rounded-lg">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <span class="text-sm font-medium">Manual de Calidad <span class="text-xs text-gray-600">(próximamente)</span></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="block p-3 bg-gray-50 rounded-lg">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <span class="text-sm font-medium">Formularios de Evaluación <span class="text-xs text-gray-600">(próximamente)</span></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="block p-3 bg-gray-50 rounded-lg">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <span class="text-sm font-medium">Preguntas Frecuentes <span class="text-xs text-gray-600">(próximamente)</span></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="block p-3 bg-gray-50 rounded-lg">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <span class="text-sm font-medium">Biblioteca de Recursos <span class="text-xs text-gray-600">(próximamente)</span></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg mb-12 overflow-hidden border-t-4 border-[#db0455]">
                        ...
                        <div class="p-8">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-4">
                                        <div class="flex items-start space-x-3">
                                            <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-green-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
                                ...
                                <p id="sinc-acceso-nota" class="text-sm text-gray-600 mb-4">El acceso en línea al sistema estará disponible próximamente.</p>
                                <div class="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <button type="button" disabled aria-describedby="sinc-acceso-nota" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg cursor-not-allowed">Acceder como Docente</button>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <button type="button" disabled aria-describedby="sinc-acceso-nota" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg cursor-not-allowed">Panel Administrativo</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
.calidad-nav-link:hover {
    background: linear-gradient(to right, rgb(219 4 85 / 0.05), rgb(184 0 63 / 0.05));
    color: #db0455;
    border-color: rgb(219 4 85 / 0.2);
...
.calidad-nav-link[aria-current="page"] {
    background: linear-gradient(to right, #b8003f, #db0455);
    color: #ffffff;
    border-color: rgb(219 4 85 / 0.3);
    box-shadow: 0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1);
    transform: translateX(0.25rem);
}

.calidad-nav-link.active svg,
.calidad-nav-link[aria-current="page"] svg {
    color: #ffffff;
}

.calidad-nav-link.active svg:last-child,
.calidad-nav-link[aria-current="page"] svg:last-child {
    transform: rotate(90deg);
}
