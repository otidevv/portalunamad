                ...
                <div class="bg-white rounded-lg shadow-lg p-8 border-t-4 border-[#db0455]">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <li class="bg-gradient-to-r from-[#db0455]/5 to-[#ed145b]/5 rounded-lg p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                            ...
                            <li class="bg-gradient-to-r from-[#ed145b]/5 to-[#db0455]/5 rounded-lg p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="space-y-2">
                                            <div class="flex items-center space-x-2">
                                                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-[#ed145b]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0H8m8 0v2a2 2 0 01-2 2H10a2 2 0 01-2-2V6m8 0H8"></path>
                                                </svg>
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <a href="mailto:rccoyuri@unamad.edu.pe" class="text-gray-600 hover:text-[#ed145b] underline transition-colors">rccoyuri@unamad.edu.pe</a>
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                                </svg>
                                                <a href="tel:+51944141493" class="text-gray-600 hover:text-[#ed145b] underline transition-colors">944 141 493</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
