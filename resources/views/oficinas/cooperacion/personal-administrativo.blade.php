...
@section('title', 'Personal Administrativo - OCRI - UNAMAD')
    ...
    <div class="relative text-white py-20" style="background-image: url('{{ asset('img/presentacion/presentacionbackground.jpg') }}'); background-size: cover; background-position: center; background-attachment: fixed;">
        ...
        <div class="relative z-10 container mx-auto px-4">
            <div class="text-center">
                ...
                <p class="text-xl md:text-2xl drop-shadow-md">Oficina de Cooperación y Relaciones Internacionales</p>
            </div>
        </div>
    </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-8 border-t-4 border-[#db0455]">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <li class="bg-gradient-to-r from-[#db0455]/5 to-[#db0455]/5 rounded-lg p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                                <div class="flex items-start space-x-4">
                                    <div class="bg-gradient-to-r from-[#b8003f] to-[#db0455] p-3 rounded-full flex-shrink-0">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="space-y-2">
                                            <div class="flex items-center space-x-2">
                                                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                                </svg>
                                                <a href="mailto:socola@unamad.edu.pe" class="text-gray-600 hover:text-[#db0455] underline transition-colors">socola@unamad.edu.pe</a>
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                                </svg>
                                                <a href="tel:+51982348359" class="text-gray-600 hover:text-[#db0455] underline transition-colors">982 348 359</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="bg-gradient-to-r from-[#db0455]/5 to-[#db0455]/5 rounded-lg p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                                <div class="flex items-start space-x-4">
                                    <div class="bg-gradient-to-r from-[#db0455] to-[#b8003f] p-3 rounded-full flex-shrink-0">
                                        <svg aria-hidden="true" focusable="false" class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                        </svg>
                                    </div>
                                    <div class="flex-1">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <a href="mailto:rccoyuri@unamad.edu.pe" class="text-gray-600 hover:text-[#b8003f] underline transition-colors">rccoyuri@unamad.edu.pe</a>
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                                </svg>
                                                <a href="tel:+51944141493" class="text-gray-600 hover:text-[#b8003f] underline transition-colors">944 141 493</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
