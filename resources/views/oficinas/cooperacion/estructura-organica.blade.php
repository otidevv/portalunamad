            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-lg shadow-lg p-8 border-t-4 border-[#db0455]">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <!-- Organigrama -->
                        <div class="bg-gradient-to-r from-[#db0455]/5 to-[#db0455]/5 rounded-lg p-6 border-l-4 border-[#db0455] mb-8">
                            ...
                            <figure class="mb-6">
                                <div class="flex justify-center">
                                    <img src="{{ asset('img/section/cooperacionrelacionesinternacionales/estructuraorganica.png') }}"
                                         alt="Organigrama: la Oficina de Cooperación y Relaciones Internacionales depende directamente del Rectorado de la UNAMAD"
                                         aria-describedby="descripcion-estructura"
                                         class="max-w-full h-auto rounded-lg shadow-lg border border-gray-200">
                                </div>
                                <figcaption class="text-center text-sm text-gray-600 italic mt-4">Estructura Organizacional - UNAMAD. Los niveles se detallan en la sección «Descripción de la Estructura».</figcaption>
                            </figure>
                        </div>
