...
<div class="bg-white rounded-lg shadow-xl mb-8 overflow-hidden border-t-4 border-[#db0455]">
    ...
    <div class="p-6">
        <nav class="space-y-1" aria-label="Secciones de la Dirección General de Administración">
            <a href="/oficinas/administracion" class="administracion-nav-link group {{ Request::is('oficinas/administracion') ? 'active' : '' }}">
                <div class="flex items-center space-x-3">
...
<div class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-[#db0455]">
    ...
    <div class="space-y-3 text-sm text-gray-600">
        ...
        <div class="flex items-center space-x-2">
            ...
            <span>administracion@unamad.edu.pe</span>
        </div>
        -->
    </div>
</div>
...
<style>
    ...
    .administracion-nav-link:hover {
        background-color: #f9fafb;
        border-color: #e5e7eb;
        transform: translateX(0.25rem);
    }

    .administracion-nav-link:hover svg {
        color: #db0455;
    }

    .administracion-nav-link:hover svg:last-child {
        transform: translateX(0.25rem);
    }

    .administracion-nav-link.active,
    .administracion-nav-link[aria-current="page"] {
    ...
    .administracion-nav-link.active svg,
    .administracion-nav-link.active span,
    .administracion-nav-link[aria-current="page"] svg,
    .administracion-nav-link[aria-current="page"] span {
        color: #db0455;
    }
</style>
