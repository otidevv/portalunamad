...
<div class="relative bg-gradient-to-r from-[#b8003f] to-[#db0455] py-20">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center text-white">
            ...
            <p class="text-xl">Vicerrectorado Académico - UNAMAD</p>
        </div>
    </div>
</div>
    ...
    <div class="container mx-auto px-4">
        <nav aria-label="Miga de pan" class="text-sm">
            <ol class="flex items-center space-x-2">
                <li><a href="/" aria-label="Inicio" class="text-gray-500 hover:text-[#b8003f] transition-colors">
