<!-- Sidebar Navigation -->
<aside class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-indigo-500">
    <div class="text-center mb-6">
        ...
        <h2 class="text-lg font-bold text-gray-800">Instituto de Investigación</h2>
        <p class="text-sm text-gray-600">Vicerrectorado de Investigación</p>
    </div>

    <nav class="space-y-1" aria-label="Secciones del Instituto de Investigación">
    ...
    <div class="mt-8 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
        <div class="flex items-center mb-2">
            ...
            <h3 class="text-sm font-semibold text-indigo-800">Investigación y Desarrollo</h3>
        </div>
