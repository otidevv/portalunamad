...
@section('content')
    <!-- Hero Section -->
    <div class="relative min-h-64 sm:min-h-80 lg:min-h-96 flex bg-gradient-to-r from-slate-600 via-gray-500 to-zinc-600">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="text-sm" aria-label="Migas de pan">
                <ol class="flex items-center space-x-2">
                    <li><a href="/" class="text-gray-600 hover:text-slate-600 transition-colors font-medium">Inicio</a></li>
