                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="/facultades/agroindustrial" class="ml-1 text-sm font-medium text-gray-700 hover:text-[#db0455] md:ml-2">Ingeniería Agroindustrial</a>
                        </div>
                    </li>
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div class="bg-gradient-to-r from-[#db0455]/5 to-[#ed145b]/5 rounded-lg p-6 border-l-4 border-[#db0455] hover:shadow-lg transition-shadow">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start space-x-2">
                                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-[#db0455] mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="bg-gradient-to-r from-[#ed145b]/5 to-[#db0455]/5 rounded-lg p-6 border-l-4 border-[#ed145b] hover:shadow-lg transition-shadow">
                                <h3 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
                                    <svg aria-hidden="true" focusable="false" class="w-6 h-6 mr-2 text-[#ed145b]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start space-x-2">
                                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-[#ed145b] mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                        </svg>
                            ...
                            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6 border-l-4 border-green-500 hover:shadow-lg transition-shadow">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start space-x-2">
                                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-green-600 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                        </svg>
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border-l-4 border-blue-500 hover:shadow-lg transition-shadow">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start space-x-2">
                                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-blue-600 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                        </svg>
