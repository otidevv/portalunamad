                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Psicología</span>
                        </div>
                    </li>
                ...
                <div class="bg-white rounded-lg shadow-lg p-8 border-t-4 border-[#db0455]">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                            <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-5 border border-blue-200 flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-800">Psicología Educativa</h4>
                                    <p class="text-gray-600 text-sm">Acompañamiento en procesos de enseñanza-aprendizaje y desarrollo educativo</p>
                                </div>
                            </div>
                            <div class="bg-gradient-to-r from-cyan-50 to-sky-50 rounded-lg p-5 border border-cyan-200 flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-800">Psicología Industrial-Organizacional</h4>
                                    <p class="text-gray-600 text-sm">Gestión del talento humano y bienestar en las organizaciones</p>
                                </div>
                            </div>
                            <div class="bg-gradient-to-r from-sky-50 to-indigo-50 rounded-lg p-5 border border-sky-200 flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-800">Psicología Clínica</h4>
                                    <p class="text-gray-600 text-sm">Evaluación, diagnóstico y tratamiento psicológico integral</p>
                                </div>
                            </div>
                            <div class="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg p-5 border border-indigo-200 flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-800">Psicología Social</h4>
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-5 border border-blue-200 flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-800">Psicología de la Salud Mental</h4>
                            ...
                            <div class="bg-gradient-to-r from-cyan-50 to-sky-50 rounded-lg p-5 border border-cyan-200 flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-800">Psicología del Desarrollo</h4>
                        ...
                        <div class="bg-white rounded-lg p-6 border border-gray-200">
                            ...
                            <div class="flex items-center justify-center">
                                <div class="text-center bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-6 border border-blue-200">
                                    <div class="text-4xl font-bold text-[#db0455] mb-1">15.00%</div>
                                    <p class="text-gray-600 text-sm">de la demanda de profesionales corresponde a Psicólogos</p>
                                </div>
                            </div>
                        </div>
                    </div>
