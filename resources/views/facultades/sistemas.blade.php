...
@section('title', 'Ingeniería de Sistemas e Informática - UNAMAD')
                ...
                <div class="bg-white rounded-lg shadow-lg p-8 border-t-4 border-[#db0455]">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-6 border-l-4 border-indigo-500 mb-8">
                            <h3 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
                                <svg aria-hidden="true" focusable="false" class="w-6 h-6 mr-2 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6 border-l-4 border-purple-500 mb-8">
                            <h3 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
                                <svg aria-hidden="true" focusable="false" class="w-6 h-6 mr-2 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <ul class="space-y-3 text-gray-700">
                                <li class="flex items-start space-x-3">
                                    <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-purple-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
