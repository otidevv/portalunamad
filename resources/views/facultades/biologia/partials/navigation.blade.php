...
<div class="bg-white rounded-lg shadow-xl mb-8 overflow-hidden border-t-4 border-[#db0455]">
    ...
    <div class="p-6">
        <nav aria-label="Secciones de Biología" id="navegacion-carrera">
            <ul class="space-y-1">
                <li>
                <a href="/facultades/biologia" class="biologia-nav-link group {{ Request::is('facultades/biologia') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                ...
                <li>
                <a href="/facultades/biologia/resena-historica" class="biologia-nav-link group {{ Request::is('facultades/biologia/resena-historica') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                <a href="/facultades/biologia/vision-mision" class="biologia-nav-link group {{ Request::is('facultades/biologia/vision-mision') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                <a href="/facultades/biologia/perfil-profesional" class="biologia-nav-link group {{ Request::is('facultades/biologia/perfil-profesional') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                <a href="/facultades/biologia/campo-ocupacional" class="biologia-nav-link group {{ Request::is('facultades/biologia/campo-ocupacional') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                <a href="/facultades/biologia/objetivos-academicos" class="biologia-nav-link group {{ Request::is('facultades/biologia/objetivos-academicos') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<style>
    ...
    .biologia-nav-link.active {
        @apply bg-white text-[#db0455] border-[#db0455] shadow-lg translate-x-1;
    }

    .biologia-nav-link.active svg {
        color: #db0455 !important;
    }

    .biologia-nav-link.active span {
        color: #db0455 !important;
    }

    .biologia-nav-link:hover .group-hover\:text-\[\#db0455\] {
        @apply text-[#db0455];
    }

    .biologia-nav-link:hover svg:last-child {
