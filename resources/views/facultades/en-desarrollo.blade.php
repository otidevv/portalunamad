...
@section('content')
    <!-- Hero Section -->
    <div class="relative min-h-64 sm:min-h-80 lg:min-h-96 flex bg-gradient-to-r from-[#db0455] via-[#db0455] to-rose-700">
            ...
            <nav class="text-sm" aria-label="Migas de pan">
                <ol class="flex items-center space-x-2">
                    ...
                    <li class="flex items-center space-x-2">
                        ...
                        <span class="text-gray-600 font-medium">Facultades</span>
                    </li>
