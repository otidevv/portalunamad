...
@section('content')
    <!-- Hero Section -->
    <div class="relative h-64 sm:h-80 lg:h-96 overflow-hidden bg-gradient-to-r from-[#db0455] via-[#db0455] to-rose-700">
        <div class="absolute inset-0 bg-black/20"></div>
        <img src="{{ asset('img/presentacion/presentacionbackground.jpg') }}"
             alt="{{ $carrera ?? 'Carrera Profesional' }}"
    ...
    <div class="bg-gradient-to-r from-gray-50 to-gray-100 border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="flex items-center space-x-2 text-sm">
                <a href="/" class="text-gray-600 hover:text-[#db0455] transition-colors font-medium">Inicio</a>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden text-center">
            <div class="h-2 bg-gradient-to-r from-[#db0455] to-[#db0455]"></div>
            <div class="p-8 sm:p-14">
                <!-- Ícono animado -->
                <div class="relative w-24 h-24 mx-auto mb-8">
                    <span class="absolute inset-0 rounded-full bg-[#db0455]/10 animate-ping"></span>
                    <div class="relative w-24 h-24 rounded-full bg-gradient-to-br from-[#db0455] to-[#db0455] flex items-center justify-center shadow-lg">
                ...
                <span class="inline-block bg-[#db0455]/10 text-[#db0455] text-xs font-bold uppercase tracking-wider px-4 py-1.5 rounded-full mb-5">
                    En desarrollo
                </span>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                    <a href="/"
                        class="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-gradient-to-r from-[#db0455] to-[#db0455] text-white font-semibold shadow-md hover:shadow-lg transition-all">
                    ...
                    <a href="https://www.unamad.edu.pe" target="_blank" rel="noopener noreferrer"
                        class="inline-flex items-center justify-center px-6 py-3 rounded-lg border border-gray-300 text-gray-700 font-semibold hover:border-[#db0455] hover:text-[#db0455] transition-all">
                        Portal UNAMAD
                    </a>
                </div>
            </div>
