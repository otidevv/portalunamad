...
<div class="bg-white rounded-lg shadow-xl mb-8 overflow-hidden border-t-4 border-[#db0455]">
    ...
    <div class="p-6">
        <nav aria-label="Secciones de Medicina Humana" id="navegacion-carrera">
            <ul class="space-y-1">
                <li>
                <a href="/facultades/medicina-humana" class="medicina-nav-link group {{ Request::is('facultades/medicina-humana') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                ...
                <li>
                <a href="/facultades/medicina-humana/resena-historica" class="medicina-nav-link group {{ Request::is('facultades/medicina-humana/resena-historica') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                <a href="/facultades/medicina-humana/vision-mision" class="medicina-nav-link group {{ Request::is('facultades/medicina-humana/vision-mision') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                <a href="/facultades/medicina-humana/perfil-profesional" class="medicina-nav-link group {{ Request::is('facultades/medicina-humana/perfil-profesional') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                <a href="/facultades/medicina-humana/campo-ocupacional" class="medicina-nav-link group {{ Request::is('facultades/medicina-humana/campo-ocupacional') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                <a href="/facultades/medicina-humana/objetivos-academicos" class="medicina-nav-link group {{ Request::is('facultades/medicina-humana/objetivos-academicos') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-600 group-hover:text-[#db0455]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<style>
    ...
    .medicina-nav-link.active {
        @apply bg-white text-[#db0455] border-[#db0455] shadow-lg translate-x-1;
    }

    .medicina-nav-link.active svg {
        color: #db0455 !important;
    }

    .medicina-nav-link.active span {
        color: #db0455 !important;
    }

    .medicina-nav-link:hover .group-hover\:text-\[\#db0455\] {
        @apply text-[#db0455];
    }

    .medicina-nav-link:hover svg:last-child {
