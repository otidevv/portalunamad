                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <div class="space-y-6 mb-8">
                            ...
                            <div class="bg-gradient-to-r from-cyan-50 to-sky-50 rounded-lg p-6 border-l-4 border-cyan-500">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start space-x-2">
                                        <svg class="w-4 h-4 text-cyan-600 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            ...
                            <div class="bg-gradient-to-r from-sky-50 to-indigo-50 rounded-lg p-6 border-l-4 border-sky-500">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start space-x-2">
                                        <svg class="w-4 h-4 text-sky-600 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
