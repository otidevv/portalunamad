...
@section('title', 'Reseña Histórica - Medicina Humana - UNAMAD')
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-6 mb-8 border-l-4 border-blue-500">
                            ...
                            <p class="text-gray-700 leading-relaxed mb-4">
                                La creación de la <strong>Carrera Profesional de Medicina Humana</strong> en la Universidad Nacional Amazónica de Madre de Dios surge como respuesta a la creciente necesidad de fortalecer la formación de profesionales de la salud en la región amazónica y contribuir al desarrollo social, sanitario y científico del país.
                            </p>
                            <p class="text-gray-700 leading-relaxed">
                                Esta iniciativa se fundamenta en las políticas nacionales orientadas a reducir las brechas de acceso a servicios de salud y en el compromiso institucional de la universidad con el desarrollo sostenible de Madre de Dios.
                            </p>
                        </div>
                            ...
                            <ol class="space-y-6">
                                ...
                                <li class="bg-white rounded-lg p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                                    <div class="flex items-start space-x-4">
                                        ...
                                        <div>
                                            <h4 class="font-semibold text-gray-800 mb-2">Estudios de Demanda Social y Pertinencia Académica</h4>
                                            <p class="text-gray-600 text-sm">La universidad realizó estudios que evidenciaron la necesidad de implementar un programa de formación médica con enfoque intercultural, humanista y orientado a la atención de los principales problemas de salud de la Amazonía.</p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="bg-white rounded-lg p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                                    <div class="flex items-start space-x-4">
                                        ...
                                        <div>
                                            <h4 class="font-semibold text-gray-800 mb-2">Condiciones Básicas de Calidad</h4>
                                            <p class="text-gray-600 text-sm">Se desarrollaron las condiciones académicas, de infraestructura, equipamiento y recursos humanos requeridas para garantizar una formación de calidad, en concordancia con las Condiciones Básicas de Calidad de la educación superior universitaria.</p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="bg-white rounded-lg p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                                    <div class="flex items-start space-x-4">
                                        ...
                                        <div>
                                            <h4 class="font-semibold text-gray-800 mb-2">Marco Legal — Ley N° 32247</h4>
                                            <p class="text-gray-600 text-sm">La Carrera Profesional de Medicina Humana fue creada en el marco de la Ley N° 32247, formalizando su incorporación a la oferta académica de la UNAMAD.</p>
                                        </div>
                                    </div>
                                </li>
                            </ol>
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-6 border-l-4 border-blue-500">
                            ...
                            <p class="text-gray-700 leading-relaxed">
                                La Escuela Profesional de Medicina Humana de la UNAMAD asume el compromiso de formar médicos altamente competentes, éticos y comprometidos con la investigación, la equidad en salud y el mejoramiento de la calidad de vida de la población local, regional y nacional.
                            </p>
                        </div>
                    </div>
                </div>
