                        ...
                        <div class="bg-white rounded-lg p-6 border border-gray-200 mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
                                    <h4 class="font-semibold text-gray-800 text-sm">Atención Integral de la Salud</h4>
                                </div>
                                <div class="text-center p-4 bg-cyan-50 rounded-lg border border-cyan-200">
                                    <h4 class="font-semibold text-gray-800 text-sm">Promoción y Prevención</h4>
                                </div>
                                <div class="text-center p-4 bg-sky-50 rounded-lg border border-sky-200">
                                    <h4 class="font-semibold text-gray-800 text-sm">Investigación Biomédica y Clínica</h4>
                                </div>
                                <div class="text-center p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                                    <h4 class="font-semibold text-gray-800 text-sm">Gestión de Servicios de Salud</h4>
                                </div>
                            </div>
                        </div>
