...
<div class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-amber-500">
    ...
    <nav aria-label="Secciones de Derecho y Ciencias Políticas" id="navegacion-carrera">
        <ul class="space-y-1">
            <li>
            <a href="/facultades/derecho" @if(Request::is('facultades/derecho')) aria-current="page" @endif
               class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ Request::is('facultades/derecho') ? 'bg-amber-100 text-amber-800 border-r-2 border-amber-500' : 'text-gray-700 hover:bg-gray-100 hover:text-amber-800' }}">
    ...
    <div class="mt-8 p-4 bg-amber-50 rounded-lg border border-amber-200">
        <div class="flex items-center mb-2">
            <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-amber-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mt-6 p-4 bg-amber-50 rounded-lg border border-amber-200">
        ...
        <div class="space-y-3">
            ...
            <!-- <div class="flex items-start space-x-2">
                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    ...
                    <a href="mailto:dir_epd@unamad.edu.pe" class="text-xs text-amber-800 hover:text-amber-900 transition-colors break-all">dir_epd@unamad.edu.pe</a>
                </div>
            </div>
