...
<div class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-pink-500">
    ...
    <div class="mt-8 p-4 bg-pink-50 rounded-lg border border-pink-200">
        <div class="flex items-center mb-2">
            <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-pink-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
            </svg>
    ...
    <div class="mt-6 p-4 bg-pink-50 rounded-lg border border-pink-200">
        ...
        <div class="space-y-3">
            ...
            <!-- <div class="flex items-start space-x-2">
                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-pink-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-start space-x-2">
                ...
                <div>
                    ...
                    <a href="mailto:epenfer@unamad.edu.pe" class="text-xs text-pink-800 hover:text-pink-900 transition-colors break-all">epenfer@unamad.edu.pe</a>
                </div>
            </div>
