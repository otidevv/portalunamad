...
<div class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-violet-500">
    ...
    <nav aria-label="Secciones de Educación: Matemática y Computación" id="navegacion-carrera">
        <ul class="space-y-1">
            <li>
            <a href="/facultades/matematica" @if(Request::is('facultades/matematica')) aria-current="page" @endif
