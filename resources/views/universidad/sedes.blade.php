...
@section('content')
    ...
    <div class="relative h-64 flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="{{ asset('img/presentacion/presentacionbackground.jpg') }}" alt="" class="w-full h-full object-cover">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-[#db0455] md:ml-2">Sedes</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="p-8">
                ...
                <div class="mb-12">
                    <div class="bg-gradient-to-br from-[#db0455]/5 to-[#db0455]/5 rounded-lg p-6 border border-[#db0455]/20 shadow-sm">
                        <h3 class="text-2xl font-bold text-[#db0455] mb-4 flex items-center">
                            ...
                            <div>
                                ...
                                <dl class="space-y-3">
                                    <div class="flex items-start">
                                        <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-[#db0455] mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                        </svg>
                                        <div>
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                        <h4 class="text-lg font-semibold text-[#db0455] mb-4 flex items-center">
