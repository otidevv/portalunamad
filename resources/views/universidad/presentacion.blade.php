        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-1">
                    ...
                    <div class="text-center">
                        <div class="relative mb-6">
                            <div class="w-48 h-48 mx-auto rounded-full overflow-hidden border-4 border-[#db0455] shadow-xl">
                                <img src="{{ asset('img/presentacion/rector.jpeg') }}" alt="Fotografía del Dr. Joab Maquera Ramírez, Rector (e) de la UNAMAD" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        <a href="{{ url('universidad/historia') }}" class="block p-3 bg-gray-50 rounded-lg hover:bg-[#db0455] hover:text-white transition-colors duration-300 group">
                            <div class="flex items-center">
                                <svg aria-hidden="true" focusable="false" class="w-5 h-5 mr-3 text-[#db0455] group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                </svg>
                                <span class="font-medium">Historia</span>
                            </div>
                        </a>
                        <a href="{{ url('universidad/autoridades') }}" class="block p-3 bg-gray-50 rounded-lg hover:bg-[#db0455] hover:text-white transition-colors duration-300 group">
                            <div class="flex items-center">
                                <svg aria-hidden="true" focusable="false" class="w-5 h-5 mr-3 text-[#db0455] group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ url('transparencia/documentos') }}" class="block p-3 bg-gray-50 rounded-lg hover:bg-[#db0455] hover:text-white transition-colors duration-300 group">
                            <div class="flex items-center">
                                <svg aria-hidden="true" focusable="false" class="w-5 h-5 mr-3 text-[#db0455] group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="font-medium">Estatuto<span class="sr-only"> (en Documentos Normativos y de Gestión)</span></span>
                            </div>
                        </a>
                        <a href="{{ url('transparencia/documentos') }}" class="block p-3 bg-gray-50 rounded-lg hover:bg-[#db0455] hover:text-white transition-colors duration-300 group">
                            <div class="flex items-center">
                                ...
                                <span class="font-medium">Plan Estratégico<span class="sr-only"> (en Documentos Normativos y de Gestión)</span></span>
                            </div>
                        </a>
                    </div>
                </div>
